      ...
      <div class="row container">
        <div class="col s12">
          <div class="card N/A transparent">
            <form class="col s12" method="POST" action="../controller/controlador_candidato.php?acao=editar2_candidato&id=<?=$id?>">
            ...
            <option value="Barra Velha">Barra Velha</option>
              ...
              <div class="file-field input-field col s6">
			      ...
			      <div class="file-path-wrapper">
			        <input class="file-path validate white-text" name="imagem" type="text" value="<?=$listaCandidato['img']?>">
			      </div>
			    </div>
          <div class="file-field input-field col s6">
          <div class="btn blue-grey">
            ...
            <div class="file-path-wrapper">
              <input class="file-path validate white-text" name="anexo" type="text" value="<?=$listaCandidato['anexo_curricular']?>">
            </div>
          </div>
              <div class="input-field col s6">
