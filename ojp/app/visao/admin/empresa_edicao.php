        ...
        <!--<form>
          ...
          <div class="col s12">
            <div class="card transparent">
              <form class="col s12" method="POST" action="controlador_empresa.php?acao=editar2_empresa&id=<?=$id?>" enctype="multipart/form-data">
              ...
              <h5 class="white-text">Prencha com os dados do proprietário empresarial</h5>
                ...
                <div class="input-field inline col s3">
                  <input  id="first_name" name="nome" name="" type="text" class="validate" value="<?=$listaEmpresa['nome']?>">
                  <label for="first_name" class="white-text">Nome</label>
                </div>
                <div class="input-field col s3">
                  <input type="text" name="data" class="datepicker" value="<?=$listaEmpresa['data']?>">
                  <label for="last_name" class="white-text">Data de Nascimento</label>
                </div>
                
                <div class="input-field col s3">
                  <input  id="first_name" name="RG" type="text" class="validate" value="<?=$listaEmpresa['RG']?>">
                  <label for="first_name" class="white-text">RG</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="CPF" type="text" class="validate" value="<?=$listaEmpresa['CPF']?>">
                  <label for="first_name" class="white-text">CPF</label>
                </div>
                
                <div class="input-field col s3">
                  <input  id="first_name" name="tel_1" type="text" class="validate" value="<?=$listaEmpresa['telefone']?>">
                  <label for="first_name" class="white-text">Telefone</label>
                </div>
                  <div class="input-field col s3">
                  <input  id="first_name" name="email" type="text" class="validate" value="<?=$listaEmpresa['email']?>">
                ...
                <div class="input-field col s3">
                  <input  id="first_name" name="nome_empresa" type="text" class="validate" value="<?=$listaEmpresa['nome_empresa']?>">
                  <label for="first_name" class="white-text">Nome da empresa</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="cnpj" type="text" class="validate" value="<?=$listaEmpresa['CNPJ']?>">
                  <label for="first_name"  class="white-text">CNPJ</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="razao_social" type="text" class="validate" value="<?=$listaEmpresa['razao_social']?>">
             ...
             name="cidade">
                ...
                <div class="input-field col s3">
                  <input  id="first_name" name="bairro" type="text" class="validate" value="<?=$listaEmpresa['bairro']?>">
                  <label for="first_name" class="white-text">Bairro</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="rua" type="text" class="validate" value="<?=$listaEmpresa['rua']?>">
                  <label for="first_name" class="white-text">Rua</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="numero" type="text" class="validate" value="<?=$listaEmpresa['numero']?>">
                  <label for="first_name" class="white-text">Número</label>
                </div>
          <div class="input-field col s3">
                  <input  id="first_name" name="cep" type="text" class="validate" value="<?=$listaEmpresa['cep']?>">
                  <label for="first_name" class="white-text">CEP</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="email_empresa" type="text" class="validate" value="<?=$listaEmpresa['email_empresa']?>">
                  <label for="first_name" class="white-text">E-mail</label>
                </div>
              ...
              <div class="col s2">
                <img width="50px" class="responsive-img circle" src="../visao/admin/img_empresa/<?=$listaEmpresa['imagem']?>">
              </div>
              <div class="file-path-wrapper col s4">
                <input class="file-path  validate" name="imagem" type="text" value="<?=$listaEmpresa['imagem']?>">
              </div>
            </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="login" type="text" class="validate" value="<?=$listaEmpresa['login']?>">
                  <label for="first_name" class="white-text">Login do usuário</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="senha" type="password" class="validate">
                  <label for="first_name" class="white-text">Senha</label>
                </div>
                <div class="input-field col s3">
                  <input  id="first_name" name="" type="password" class="validate">
