<?php 
session_start();
  $_SESSION['id'] =  $listaCandidato['id_candidato'];
?>
    <style type="text/css">
    	body {
    ...
    <div class="row container">
      <div class="col s12">
        <div class="card N/A transparent">
          <form class="col s12" method="POST" action="../controller/controlador_candidato.php?acao=editar2_candidato&id=<?=$_SESSION['id']?>" enctype="multipart/form-data" >
            ...
            <div class="input-field inline col s3">
              <input  id="first_name" name="nome"  type="text" class="validate white-text" value="<?=$listaCandidato['nome']?>">
              <label for="first_name" class="white-text">Nome</label>
            </div>
            <div class="input-field col s3">
              <input name="data" type="text" class="datepicker white-text" value="<?=$listaCandidato['data']?>">
              <label for="last_name" class="white-text">Data de Nascimento</label>
            </div>
            <div class="input-field col s3">
              <input  id="first_name" name="RG" type="text" class="validate white-text" value="<?=$listaCandidato['rg']?>">
              <label for="first_name" class="white-text">RG</label>
            </div>
            <div class="input-field col s3">
              <input  id="first_name" name="CPF" type="text" class="validate white-text" value="<?=$listaCandidato['cpf']?>">
              <label for="first_name" class="white-text">CPF</label>
            </div>
            <div class="input-field col s3">
              <input  id="first_name" name="carteira" type="text" class="validate white-text" value="<?=$listaCandidato['carteira_trabalho']?>">
              <label for="first_name" class="white-text">Carteira de Trabalho</label>
            </div>  
            <div class="input-field col s3">
              <input  id="first_name" name="telefone_1" type="text" class="validate white-text" value="<?=$listaCandidato['tel_1']?>">
              <label for="first_name" class="white-text">Celular</label>
            </div>
  	        <div class="input-field col s3">
              <input  id="first_name" name="telefone_2" type="text" class="validate white-text" value="<?=$listaCandidato['tel_1']?>">
         ...
         name="cidades">
		      <option value="<?=$listaCandidato['cidade']?>"  class="white-text"><?=$listaCandidato['cidade']?></option>
          ...
          <option value="Barra Velha">Barra Velha</option>
            ...
            <div class="input-field col s3">
              <input  id="first_name" name="bairro" type="text" class="validate white-text" value="<?=$listaCandidato['bairro']?>">
              <label for="first_name" class="white-text">Bairro</label>
            </div>
            <div class="input-field col s3">
              <input  id="first_name" name="rua" type="text" class="validate white-text" value="<?=$listaCandidato['rua']?>">
              <label for="first_name" class="white-text">Rua</label>
            </div>
            <div class="input-field col s3">
              <input  id="first_name" name="numero" type="text" class="validate white-text" value="<?=$listaCandidato['numero']?>">
              <label for="first_name" class="white-text">Número</label>
            </div>
		        <div class="input-field col s3">
              <input  id="first_name" name="cep" type="text" class="validate white-text" value="<?=$listaCandidato['cep']?>">
              <label for="first_name" class="white-text">CEP</label>
            </div>
            <div class="file-field input-field col s6">
  		      <div class="btn blue-grey col s6">
              <span>Imagem de Perfil</span>
              <input name="bt_imagem" type="file">
            </div>
          <div class="col s2">
            <img width="50px" class="responsive-img circle" src="../visao/img_candidato/<?= $listaCandidato['img']?>">
          </div>
          <div class="file-path-wrapper col s4">
            <input class="file-path validate white-text" name="imagem" type="text" placeholder="formato .jpg" value="<?= $listaCandidato['img']?>">
          </div>
		    </div>
        <div class="file-field input-field col s6">
        <div class="btn blue-grey col s6">
          ...
          <div class="col s2">
            <img width="50px" class="responsive-img circle" src="../visao/img_candidato/<?= $listaCandidato['anexo_curricular']?>">
          </div>
          <div class="file-path-wrapper col s4">
            <input class="file-path validate white-text" name="anexo" type="text" placeholder="formato livre" value="<?= $listaCandidato['anexo_curricular']?>">
          </div>
        </div>
            <div class="input-field col s3">
              <input  id="first_name" name="email" type="email" class="validate white-text" value="<?=$listaCandidato['email']?>">
              <label for="first_name" class="white-text">E-mail</label>
            </div>
            <div class="input-field col s3">
              <input  id="first_name" name="login" type="text" class="validate white-text" value="<?=$listaCandidato['login']?>">
        ...
        <input class="with-gap" name="matutino" name="" type="checkbox" id="Matutino"  />
        <label for="Matutino" class="white-text">Matutino</label>

        <input class="with-gap" name="vespertino" name="vespertino" type="checkbox" id="Vespertino"  />
